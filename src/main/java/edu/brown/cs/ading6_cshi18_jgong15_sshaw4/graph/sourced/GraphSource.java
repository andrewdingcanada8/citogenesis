 ...
 * implemented by the user to leverage the {@link SourcedGraph}, {@link SourcedEdge},
 * and {@link SourcedVertex} classes. Defines how to obtain vertex edges based on
 * a given vertex, presumably drawn from an external source (Database, CSV, Web API, etc.).
 * classes.
 * @param <T> Value type stored in Graph {@link SourcedVertex}
...
public interface GraphSource<T, W> {
   ...
   * @param val {@link SourcedVertex} from which to find Graph edges.
